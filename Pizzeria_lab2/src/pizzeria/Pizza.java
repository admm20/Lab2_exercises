...
import static pizzeria.Ingredient.*;
...
public enum Pizza {
    ...
    HAVAI("Havai", THIN_CRUST, TOMATO_SUACE, CHEESE, HAM,
            PINEAPPLE),
    CARUSO("Caruso", THIN_CRUST, TOMATO_SUACE, SUASAGE, //12+0+2+1 = 15
            PEPERONI),
    MAMA_MIA("Mama Mia", THIN_CRUST, TOMATO_SUACE, CHEESE, ONION,
            MUSHROOMS, BECON),
    SOPRANO("Soprano", THICK_CRUST, TOMATO_SUACE, CHEESE, HAM, //14+0+1+3+1+1+3+0=23
    ...
    TABASCO("Tabasco", THICK_CRUST, TOMATO_SUACE, CHEESE, HAM, //14+0+1+3+2+1+1+0=22
